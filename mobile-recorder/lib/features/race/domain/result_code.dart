...
enum ResultCode {
  ...
  ocs('OCS', 'Over line at start or broke rule 30.1 (I Flag)', ResultCodeGroup.start, true),
  ...
  xpa('XPA', 'Exoneration penalty - Advisory Hearing/RYA Arbitration.', ResultCodeGroup.penalty, false),
